...
Sert surtour pour le combat multiple.*/
	...
	/***/
	const static QStringList _descriptions_attaques_gener_;

	/***/
	static HashMap<QString,QString> init_descriptions_attaques_particul();

	/***/
	const static HashMap<QString,QString> _descriptions_attaques_particul_;
...
public:
	...
	QString description_part(const QString&,int)const;

	/**Donne la description d'un objet.
	appelle description_part
	@param _langue langue de destination*/
	QString description(const QString&,int)const;
