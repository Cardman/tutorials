...
public class DefTextFactTest {
    @Test
    public void t1() {
        StringMap<String> f = new StringMap<String>();
        f.put("abc","abc");
        assertEquals("abc",new DefTextFact(new MockTextFactory(f)).contentsOfFile("abc",new DefaultUniformingString(),3));
    }
    @Test
    public void t2() {
        StringMap<String> f = new StringMap<String>();
