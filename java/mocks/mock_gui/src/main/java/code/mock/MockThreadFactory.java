...
public class MockThreadFactory implements AbstractThreadFactory {
    ...
    @Override
    public AbstractAtomicBoolean newAtomicBoolean(boolean b) {
        return new MockAtomicBoolean(b);
    }
    ...
    @Override
    public AbstractAtomicInteger newAtomicInteger(int i) {
        return new MockAtomicInteger(i);
    }
    ...
    @Override
    public AbstractAtomicLong newAtomicLong(long l) {
        return new MockAtomicLong(l);
    }
}
