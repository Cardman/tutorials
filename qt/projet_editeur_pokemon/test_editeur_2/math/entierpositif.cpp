...
#include <QStringList>
#include <QRegExp>
const qulonglong EntierPositif::_base_=1000000000;
const int EntierPositif::_base_numer_=10;

int EntierPositif::log_base(){
	int puissance10=0;
	unsigned long long copie_b=1;
...
EntierPositif::EntierPositif(const EntierPositif& _copie){
	gr_chiffres=_copie.gr_chiffres;
}

EntierPositif& EntierPositif::operator=(const EntierPositif& _autre){
	gr_chiffres=_autre.gr_chiffres;
	return (*this);
}
