...
QString Evolution::description(const QString& _base,const QString& _evo,int _langue,Donnees* _d)const{
	QString base_=Utilitaire::traduire(_d->val_noms_pk(),_base,_langue);
	QString evo_=Utilitaire::traduire(_d->val_noms_pk(),_evo,_langue);
	QStringList args_;
	args_<<base_;
	args_<<evo_;
