export class NoteUtils{
    ...
    static readonly VERT_NOTE_HEIGHT = 32;
    static readonly OFF_DIESE_NOTE = 0;
    static readonly OFF_NOTE = 10;
    static readonly NO_NOTE = -1;
    static readonly BLACK_KEY_HEIGHT = 60;
    static readonly BLACK_KEY_HALF_WIDTH = 5;
    static readonly WHITE_KEY_HEIGHT = 100;
    static readonly WHITE_KEY_WIDTH = 20;
    ...
    static readonly BOTTOM_PART = NoteUtils.BOTTOM_LOWER_LINES + 64;
