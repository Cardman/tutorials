...
**
** Created: Tue Jun 26 23:40:37 2012
...
static const char qt_meta_stringdata_Grille[] = {
    "Grille\0\0selection(QPair<QPair<int,int>,QPair<int,int> >)\0"
};

const QMetaObject Grille::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Grille,
      qt_meta_data_Grille, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Grille::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Grille))
        return static_cast<void*>(const_cast< Grille*>(this));
...
// SIGNAL 0
void Grille::selection(const QPair<QPair<int,int>,QPair<int,int> > & _t1)
{
