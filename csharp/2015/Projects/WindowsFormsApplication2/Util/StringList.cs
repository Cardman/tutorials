...
namespace Util
{
    public class StringList : MyList<string>
    {
        ...
        public StringList(IEnumerable<String> _list) : base(_list)
        {
        }
        ...
        public static String formatQuote(String _pattern, Map<String, String> _map)
        {
    ...
    public static class Extensions
    {
        ...
        public static String replaceAll(this string _str, string _tok, string _rep)
        {
            Regex reg_ = new Regex(_tok);
            return reg_.Replace(_str, _rep);
        }
    }
}
