...
{
    public class MySimpleList<T> : IEnumerable<T>
    {
    ...
    public class ExClass
    {
        public static void Call()
        {
            string Ex = "";
            //Ex.Substring()
            Console.WriteLine(Card.ACE.GetCardValue());
            Console.WriteLine(Card.KING.GetCardValue());
            Console.WriteLine(Card.QUEEN.GetCardValue());
            Console.WriteLine(Card.JACK.GetCardValue());
            Console.WriteLine("hello".substring(3, 5));
            Console.WriteLine("hello".substring(3, 3));
            //StringBuilder s = new StringBuilder('c');
        }
    }
    public static class Enums
    {
        public static string substring(this string s, int from, int to)
        {
            return s.Substring(from, to - from);
        }
        public static int GetCardValue(this Card c)
        {
            return c.ordinal();
        }
